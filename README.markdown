...
This directory contains source files for the Amharic language morphology
...
-   <https://giellalt.uit.no/lang/amh/index.html> (analyser)
...
The Amharic language sources can be acquired using [giella SVN
